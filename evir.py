...
from evir_bullet import EvirBullet
...
sprites = [
    [(0, 276), (38, 276), (75, 276), (112, 276), (149, 276), (186, 276), (223, 276), (260, 276)],
    [(0, 223), (38, 223), (75, 223), (112, 223), (149, 223), (186, 223), (223, 223)]
]
...
class Evir:
    ...
    def __init__(self, x=None, y=None):
        ...
        if Evir.image == None:
            Evir.image = load_image('resources/sprites/relic2_evir.png')
    ...
    def get_bb(self):
        ...
        return sx - self.w / 2, sy - self.h / 2 + 20, sx + self.w / 2, sy + self.h /2
    ...
    def draw(self):
        ...
        if math.cos(self.dir) < 0:
            Evir.image.clip_composite_draw(sprites[animationNames[self.state]][int(self.frame)][0],
    ...
    def attack_player(self):
        ...
        if self.frame >= FRAMES_PER_ATTACK - 0.1:
            if self.attack_timer == 0.0:
                ...
                bullet = EvirBullet(self.x, self.y, common.player.x, common.player.y, 7)
